            ...
            <div class="main-slider an-si">
                <div class="bend niceties preview-2 hm-ver-1">
                    <div id="ensign-nivoslider-2" class="slides">	
                        <img src="<?=base_url('template')?>/img/slider/1.png" alt="" title="#slider-direction-3"  />
                        <img src="<?=base_url('template')?>/img/slider/2.png" alt="" title="#slider-direction-1"  />
                    </div>
                    <!-- direction 1 -->
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-box banner-box-re">
                                <a href="<?=base_url('template')?>/#">
                                    <img alt="" src="<?=base_url('template')?>/img/banner/2.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                            ...
                            <div class="banner-box res-btm">
                                <a href="<?=base_url('template')?>/#">
                                    <img alt="" src="<?=base_url('template')?>/img/banner/3.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-container banner-box res-btm">
                                <a href="<?=base_url('template')?>/#">
                                    <img alt="" src="<?=base_url('template')?>/img/banner/r6.png">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-box banner-box-re">
                                <a href="<?=base_url('template')?>/#">
                                    <img alt="" src="<?=base_url('template')?>/img/banner/4.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                            ...
                            <div class="banner-box">
                                <a href="<?=base_url('template')?>/#">
                                    <img alt="" src="<?=base_url('template')?>/img/banner/5.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="product-tab nav nav-tabs">
							<ul>                                        
								<li class="active"><a data-toggle="tab" href="<?=base_url('template')?>/#all">all shop</a></li>
								<li><a data-toggle="tab" href="<?=base_url('template')?>/#clothings">clothings</a></li>
								<li><a data-toggle="tab" href="<?=base_url('template')?>/#shoes">shoes</a></li>
								<li><a data-toggle="tab" href="<?=base_url('template')?>/#bags">bags</a></li>
								<li><a data-toggle="tab" href="<?=base_url('template')?>/#accessories">accessories</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div id="tab-carousel-1" class="re-owl-carousel owl-carousel product-slider owl-theme">
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        <a href="<?=base_url('template')?>/#">
                                            <img src="<?=base_url('template')?>/img/products/9.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="<?=base_url('template')?>/img/products/10.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="<?=base_url('template')?>/#">Product Title</a></h3>
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="<?=base_url('template')?>/#">
                                            <img src="<?=base_url('template')?>/img/products/14.jpg" alt="Product Title" />
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="<?=base_url('template')?>/#">
                                            <img src="<?=base_url('template')?>/img/products/15.jpg" alt="Product Title" />
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="<?=base_url('template')?>/#">
                                            ...
                                            <img class="secondary-image" alt="Product Title" src="<?=base_url('template')?>/img/products/1.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="<?=base_url('template')?>/#">Product Title</a></h3>
								...
								<div class="single-product">
                                    <div class="product-img">
                                        <a href="<?=base_url('template')?>/#">
                                            ...
                                            <img class="secondary-image" alt="Product Title" src="<?=base_url('template')?>/img/products/3.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="<?=base_url('template')?>/#">Product Title</a></h3>
						...
						<div id="tab-carousel-2" class="owl-carousel product-slider owl-theme">
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        <a href="<?=base_url('template')?>/#">
                                            <img src="<?=base_url('template')?>/img/products/12.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="<?=base_url('template')?>/img/products/11.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="<?=base_url('template')?>/#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="<?=base_url('template')?>/#">
                                            <img src="<?=base_url('template')?>/img/products/8.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="<?=base_url('template')?>/img/products/7.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="<?=base_url('template')?>/#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="<?=base_url('template')?>/#">
                                            <img src="<?=base_url('template')?>/img/products/14.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="<?=base_url('template')?>/img/products/13.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="<?=base_url('template')?>/#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="<?=base_url('template')?>/#">
                                            <img src="<?=base_url('template')?>/img/products/6.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="<?=base_url('template')?>/img/products/7.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        <a href="<?=base_url('template')?>/#">
                                            <img src="<?=base_url('template')?>/img/products/4.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="<?=base_url('template')?>/img/products/5.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="<?=base_url('template')?>/#">Product Title</a></h3>
                            ...
                            <div id="testimonials" class="re-owl-carousel2 owl-carousel product-slider owl-theme">
                                <div class="single-testimonial">
                                    ...
                                    <div class="testimonial-img">
                                        <a href="<?=base_url('template')?>/#"><img src="<?=base_url('template')?>/img/testimonial/1.png" alt="Title" /></a>
                                        <h4><a href="<?=base_url('template')?>/#">Raymond Morales</a></h4>
                                        <span>chairman</span>
                                    </div>
                                </div>
                                ...
                                <div class="single-testimonial">
                                    ...
                                    <div class="testimonial-img">
                                        <a href="<?=base_url('template')?>/#"><img src="<?=base_url('template')?>/img/testimonial/2.png" alt="Title" /></a>
                                        <h4><a href="<?=base_url('template')?>/#">Raymond Morales</a></h4>
                                        <span>chairman</span>
                                    </div>
                                </div>
                                ...
                                <div class="single-testimonial">
                                    ...
                                    <div class="testimonial-img">
                                        <a href="<?=base_url('template')?>/#"><img src="<?=base_url('template')?>/img/testimonial/3.png" alt="Title" /></a>
                                        <h4><a href="<?=base_url('template')?>/#">Raymond Morales</a></h4>
                                        <span>chairman</span>
                                    </div>
                                </div>
				...
				<div class="row">
					<div id="blog" class="owl-carousel product-slider owl-theme re-blog">
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="<?=base_url('template')?>/#"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="<?=base_url('template')?>/img/blog/111.jpg"></a>
                                </div>
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <a href="<?=base_url('template')?>/#"> 75 of Ralph Laurenӳ</a>
                                    </h2>
                                    <div class="blog-meta">
                                        <span class="post-category">
                                            in
                                            <a rel="category" href="<?=base_url('template')?>/#">Fashion</a>
                                        </span>
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="<?=base_url('template')?>/#"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="<?=base_url('template')?>/img/blog/222.jpg"></a>
                                </div>
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <a href="<?=base_url('template')?>/#"> 75 of Ralph Laurenӳ</a>
                                    ...
                                    <div class="blog-meta">
                                        <span class="post-category">
                                            in
                                            <a rel="category" href="<?=base_url('template')?>/#">Men</a>
                                        </span>
                                        <span class="published">
                                            <i class="fa fa-clock-o"></i>
                                            Oct 31, 2014
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="<?=base_url('template')?>/#"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="<?=base_url('template')?>/img/blog/333.jpg"></a>
                                </div>
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <a href="<?=base_url('template')?>/#"> 75 of Ralph Laurenӳ</a>
                                    ...
                                    <div class="blog-meta">
                                        <span class="post-category">
                                            in
                                            <a rel="category" href="<?=base_url('template')?>/#">Women</a>
                                        </span>
                                        <span class="published">
                                            <i class="fa fa-clock-o"></i>
                                            Oct 31, 2014
													...
													<div class="quick-image">
														...
														<div class="quick-thumb">
															<div class="nav nav-tabs">
																<ul>
																	<li><a data-toggle="tab" href="<?=base_url('template')?>/#sin-pro-1"> <img src="<?=base_url('template')?>/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="<?=base_url('template')?>/#sin-pro-2"> <img src="<?=base_url('template')?>/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="<?=base_url('template')?>/#sin-pro-3"> <img src="<?=base_url('template')?>/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="<?=base_url('template')?>/#sin-pro-4"> <img src="<?=base_url('template')?>/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																</ul>
															</div>
														</div>
													</div>							
													...
													<div class="quick-right">
														<div class="quick-right-text">
															...
															<div class="rating">
																...
																<a href="<?=base_url('template')?>/#">06 Review</a>
																<a href="<?=base_url('template')?>/#">Add review</a>
															</div>
															<div class="amount">
																<h4>$65.00</h4>
															</div>
																...
																<div class="col-sm-12 col-md-6">
																	<div class="por-dse responsive-strok clearfix">
																		<ul>
																			...
																			<li><span>Category</span><strong>:</strong> <a href="<?=base_url('template')?>/#">Men</a> <a href="<?=base_url('template')?>/#">Fashion</a> <a href="<?=base_url('template')?>/#">Shirt</a></li>
																		</ul>
																	</div>
																</div>
																<div class="col-sm-12 col-md-6">
																	<div class="por-dse color">
																		<ul>
																			<li><span>color</span><strong>:</strong> <a href="<?=base_url('template')?>/#">Red</a> <a href="<?=base_url('template')?>/#">Green</a> <a href="<?=base_url('template')?>/#">Blue</a> <a href="<?=base_url('template')?>/#">Orange</a></li>
																			<li><span>size</span><strong>:</strong>  <a href="<?=base_url('template')?>/#">SL</a> <a href="<?=base_url('template')?>/#">SX</a> <a href="<?=base_url('template')?>/#">M</a> <a href="<?=base_url('template')?>/#">XL</a></li>
																			<li><span>tag</span><strong>:</strong> <a href="<?=base_url('template')?>/#">Men</a> <a href="<?=base_url('template')?>/#">Fashion</a> <a href="<?=base_url('template')?>/#">Shirt</a></li>
																		</ul>
																	</div>
																</div>
															</div>
																...
																<div class="row">
																		...
																		<div class="por-dse clearfix">
																			<ul>
																				...
																				<li class="share-btn clearfix"><span>share</span>
																					<a href="<?=base_url('template')?>/#"><i class="fa fa-facebook"></i></a>
																					<a href="<?=base_url('template')?>/#"><i class="fa fa-twitter"></i></a>
																					<a href="<?=base_url('template')?>/#"><i class="fa fa-google-plus"></i></a>
																					<a href="<?=base_url('template')?>/#"><i class="fa fa-linkedin"></i></a>
																					<a href="<?=base_url('template')?>/#"><i class="fa fa-instagram"></i></a>
																				</li>
																			</ul>
																		</div>
																	</div>
																	<div class="col-sm-12 col-md-6">
																		<div class="por-dse clearfix responsive-othre">
																			<ul class="other-btn">
																				<li><a href="<?=base_url('template')?>/#"><i class="fa fa-heart"></i></a></li>
																				<li><a href="<?=base_url('template')?>/#"><i class="fa fa-refresh"></i></a></li>
																				<li><a href="<?=base_url('template')?>/#"><i class="fa fa-envelope-o"></i></a></li>
																			</ul>
																		</div>
																		<div class="por-dse add-to">
																			<a href="<?=base_url('template')?>/#">add to cart</a>
																		</div>
																	</div>
																</div>
															</div>
												...
												<div class="col-xs-12 col-sm-5">
													<div class="quick-image">
														...
														<div class="quick-thumb">
															<div class="nav nav-tabs">
																<ul>
																	<li><a data-toggle="tab" href="<?=base_url('template')?>/#sin-pro-5"> <img src="<?=base_url('template')?>/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="<?=base_url('template')?>/#sin-pro-6"> <img src="<?=base_url('template')?>/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="<?=base_url('template')?>/#sin-pro-7"> <img src="<?=base_url('template')?>/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="<?=base_url('template')?>/#sin-pro-8"> <img src="<?=base_url('template')?>/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																</ul>
															</div>
														</div>
													</div>							
							...
							<div id="brand-logo" class="re-owl-carousel21 owl-carousel product-slider owl-theme">
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="<?=base_url('template')?>/#"><img src="<?=base_url('template')?>/img/brand/1.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="<?=base_url('template')?>/#"><img src="<?=base_url('template')?>/img/brand/2.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="<?=base_url('template')?>/#"><img src="<?=base_url('template')?>/img/brand/3.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="<?=base_url('template')?>/#"><img src="<?=base_url('template')?>/img/brand/4.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="<?=base_url('template')?>/#"><img src="<?=base_url('template')?>/img/brand/5.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="<?=base_url('template')?>/#"><img src="<?=base_url('template')?>/img/brand/6.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
